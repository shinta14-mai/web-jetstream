...
class RekomteknisController extends Controller
{
    /**
    ...
    {
        return Inertia::render('Rekomtek/Create');
    }
    ...
    public function store(Request $request)
    {
        ...
        if (Rekomteknis::where('code', $code)->exists()) {
        ...
        return Inertia::render('Rekomtek/Store', [
            'code' => $codeR,
        ]);
    }
     ...
     *
     * @param  \App\Models\Rekomteknis  $rekomteknis
     * @return \Illuminate\Http\Response
     * @param  int  $id
     */
    public function show(Rekomteknis $id)
    {
        $rt = Rekomteknis::find($id);
        return Inertia::render('Rekomtek/Details', [
            'rt' => $rt,
        ]);
    }
    ...
    {
        $rt = Rekomteknis::find($id);
        return Inertia::render('Rekomtek/Edit', [
            'rt' => $rt
        ]);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        Rekomteknis::where('id', $id)->update([
     ...
     * @return \Illuminate\Http\Response
     */
    public function destroy(Rekomteknis $rekomteknis)
    {
        //
    }
}
